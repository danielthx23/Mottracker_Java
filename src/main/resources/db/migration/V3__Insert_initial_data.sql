...
VALUES ('Administrador', '12345678901', 'admin@mottu.com', '123456', '123456789', SYSDATE, SYSDATE);

-- Insert manager user
INSERT INTO mt_usuario_java (nome_usuario, cpf_usuario, email_usuario, senha_usuario, cnh_usuario, data_nascimento_usuario, criado_em_usuario)
VALUES ('Gerente', '98765432109', 'gerente@mottu.com', '123456', '987654321', SYSDATE, SYSDATE);

-- Insert operator user
INSERT INTO mt_usuario_java (nome_usuario, cpf_usuario, email_usuario, senha_usuario, cnh_usuario, data_nascimento_usuario, criado_em_usuario)
VALUES ('Operador', '11122233344', 'operador@mottu.com', '123456', '111222333', SYSDATE, SYSDATE);

-- Insert regular user
INSERT INTO mt_usuario_java (nome_usuario, cpf_usuario, email_usuario, senha_usuario, cnh_usuario, data_nascimento_usuario, criado_em_usuario)
VALUES ('Usuário', '55566677788', 'usuario@mottu.com', '123456', '555666777', SYSDATE, SYSDATE);
...
VALUES ('ABC1234', 'Honda CG 160', 2023, 15000, 'MOTO001', 'NO_PATIO', 'Excelente', 1);

INSERT INTO mt_moto_java (placa_moto, modelo_moto, ano_moto, quilometragem_moto, identificador_moto, estado_moto, condicoes_moto, moto_patio_atual_id)
VALUES ('DEF5678', 'Yamaha Fazer 250', 2022, 25000, 'MOTO002', 'RETIRADA', 'Boa', 1);

INSERT INTO mt_moto_java (placa_moto, modelo_moto, ano_moto, quilometragem_moto, identificador_moto, estado_moto, condicoes_moto, moto_patio_atual_id)
VALUES ('GHI9012', 'Kawasaki Ninja 300', 2023, 8000, 'MOTO003', 'NO_PATIO', 'Excelente', 2);
